...
%   - Affaiblissement atmosphérique (Gaz, Nuage, Scintillation, Pluie)
%   - Eb/No requis
%   - C/N désirer
%   - Sensibilité du récepteur
%   - Puissance d'émission nécessaire pour le satellite
...
marge=0;%(consideration de perte en feeder considérée comme 0 dans le satellite)
